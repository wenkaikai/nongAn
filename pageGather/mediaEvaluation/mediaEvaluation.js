...
Page({
    ...
    onLoad: function (options) {
        ...
        if (subTitle == "媒体评价") {
            common.ajax({
                url: app.globalData.baseUrl1 + "/api/pc/get_media_evaluation",
                data: {
                ...
                if (res.status == 1 || res.status == 2) {
                    ...
                    res.data.forEach(function (i, j) {
                        let tempObj = {
                            ...
                            title: i.title,// 标题
                            file_content: i.file_content,// 档案内容
                            file_property: i.file_property,// 档案性质
                            add_date: i.add_date, // 添加时间
                            file_no: i.file_no,// 档案编号
                            relate_url: i.relate_url,// 相关链接
                            release_media: i.release_media,// 发布媒体
                            listContent: [
                                {
                                    title: "",
                                    content: i.title,
    ...
    toInfo(e) {
        ...
        let baseUrl = "/pages/mediaText/mediaText";
